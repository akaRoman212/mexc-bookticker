"""
Configuration file for MEXC Book Ticker Data Streamer
Change the SYMBOLS here to stream different trading pairs
"""
...
# Output settings
OUTPUT_DIRECTORY = "bookticker_data"  # Directory for CSV files
